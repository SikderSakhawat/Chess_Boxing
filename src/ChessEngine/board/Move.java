...
public abstract class Move {
    ...
    String disambiguationFile() {
        for(final Move move : this.board.currentPlayer().getLegalMoves()) {
            if(move.getDestinationCoordinate() == this.destinationCoordinate && !this.equals(move) &&
                ...
                return BoardUtility.INSTANCE.getPositionAtCoordinate(this.movedPiece.getPiecePosition()).substring(0, 1);
            }
        }
        return "";
    }
    ...
    public static class PawnPromotion extends PawnMove {
        ...
        public String toString() {
            return BoardUtility.INSTANCE.getPositionAtCoordinate(this.movedPiece.getPiecePosition()) + "-" +
                    BoardUtility.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate) + "=" + this.promotionPiece.getPieceType();
        }
    ...
    public static class MajorMove extends Move {
        ...
        public String toString() {
            return movedPiece.getPieceType().toString() + disambiguationFile() +
                    BoardUtility.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static class PawnMove extends Move {
        ...
        @Override
        public String toString() {
            return BoardUtility.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static class PawnAttackMove extends AttackMove {
        ...
        @Override
        public String toString() {
            return BoardUtility.INSTANCE.getPositionAtCoordinate(this.movedPiece.getPiecePosition()).substring(0, 1) + "x" +
                    BoardUtility.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
