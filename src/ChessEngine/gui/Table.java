...
public final class Table extends Observable {
    ...
    private JMenu createOptionsMenu() {
        ...
        escapeAnalysis.addActionListener(e -> {
            ...
            if(lastMove != null) {
                System.out.println(MoveUtility.exchangeScore(lastMove));
            }
    ...
    private class TilePanel extends JPanel {
        ...
        TilePanel(final BoardPanel boardPanel,
            ...
            addMouseListener(new MouseListener() {
                ...
                public void mouseClicked(final MouseEvent event) {
                    ...
                    if(Table.get().getGameSetup().isAIPlayer(Table.get().getGameBoard().currentPlayer()) ||
                            BoardUtility.isEndGame(Table.get().getGameBoard())) {
                        return;
                    }
        ...
        private void assignTileColor() {
            if (BoardUtility.INSTANCE.FIRST_ROW.get(this.tileId) ||
                    BoardUtility.INSTANCE.THIRD_ROW.get(this.tileId) ||
                    BoardUtility.INSTANCE.FIFTH_ROW.get(this.tileId) ||
                    BoardUtility.INSTANCE.SEVENTH_ROW.get(this.tileId)) {
                setBackground(this.tileId % 2 == 0 ? lightTileColor : darkTileColor);
            } else if(BoardUtility.INSTANCE.SECOND_ROW.get(this.tileId) ||
                    BoardUtility.INSTANCE.FOURTH_ROW.get(this.tileId) ||
                    BoardUtility.INSTANCE.SIXTH_ROW.get(this.tileId)  ||
                    BoardUtility.INSTANCE.EIGHTH_ROW.get(this.tileId)) {
                setBackground(this.tileId % 2 != 0 ? lightTileColor : darkTileColor);
            }
        }
    }
