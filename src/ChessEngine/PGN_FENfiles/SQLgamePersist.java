...
public class SQLgamePersist implements PGNpersist {

    private final Connection dbConnection;

    private static SQLgamePersist INSTANCE = new SQLgamePersist();
...
//        createMovesIndex();
    ...
    public static SQLgamePersist get() {
        return INSTANCE;
    }
    ...
    private Move queryBestMove(final Board board,
        ...
        return PGNUtil.createMove(board, bestMove);
    }
